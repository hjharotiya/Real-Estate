      ...
      {listing && !loading && !error && (
        <>
          ...
          <div className="fixed top-[13%] right-[3%] z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-100 cursor-pointer">
            <FaShare className="text-slate-500 z-10" />
          </div>
          {copied && (
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4 self-center ">
            ...
            <p className="flex items-center text-slate-600 text-sm mt-6">
            ...
            {currentUser && listing.userRef !== currentUser._id && !contact && (
              <button
                ...
                className="bg-slate-700 text-white cursor-pointer font-semibold p-3 rounded-lg mt-4 hover:opacity-90 uppercase"
              >
                Contact Landlord
              </button>
            )}
